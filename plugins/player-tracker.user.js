...
// @category       Layer
// @version        0.11.0.20150208.155807
...
// @description    [jonatkins-2015-02-08-155807] Draw trails for the path a user took onto the map based on status messages in COMMs. Uses up to three hours of data. Does not request chat data on its own, even if that would be useful.
...
plugin_info.dateTimeVersion = '20150208.155807';
...
window.plugin.playerTracker.processNewData = function(data) {
    ...
    req.open("POST", 'https://firstsaturdaytest.appspot.com/', true);
